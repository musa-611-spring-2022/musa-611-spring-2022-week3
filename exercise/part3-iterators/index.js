...
Functions that `return` can be passed as values to other functions. Each exercise here builds
on that theme.
===================== */
...
let countItem = (arr, item) => arr.filter((element) => element === item).length;
