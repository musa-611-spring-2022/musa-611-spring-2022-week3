...
let plusOne = (originalnum) =>  originalnum + 1;
...
let timesThree = (originalnum) => originalnum * 3;
...
let reduceSum = (arr) => arr.reduce((a, b) => add(a, b), 0);
...
let reduceProduct = (arr) => arr.reduce((a, b) => multiply(a, b), 1);
