...
let plusOne = (newNum) => return newNum + 1;
...
let timesThree = (newNum) => return newNum * 3;
...
let add = (newNum1, newNum2) => return newNum1 + newNum2;
...
let multiply = (newNum1, newNum2) => return newNum1 * newNum2;
...
let valueAtIndex = (list, index) => return list[index];
...
let valueAtKey = (name, value) => return name[value];
