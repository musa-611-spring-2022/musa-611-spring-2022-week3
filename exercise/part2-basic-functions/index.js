...
let timesThree = (number) => { return number * 3 };
...
let valueAtIndex = (list, number) => { return list[number] };
...
let valueAtKey = (list, key) => { return list[key] };

console.log('valueAtKey success:', valueAtKey({'name': 'Nathan'}, 'name') === 'Nathan');
